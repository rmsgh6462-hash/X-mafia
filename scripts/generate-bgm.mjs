...
console.log('Generating day BGM…');
const day = renderDayLoop(samples, SAMPLE_RATE, mulberry32(0xda42));
writeWavStereo(join(OUT_DIR, 'bgm-day.wav'), day.left, day.right, SAMPLE_RATE);

console.log('Generating night BGM…');
const night = renderNightLoop(samples, SAMPLE_RATE, mulberry32(0x71a8));
writeWavStereo(join(OUT_DIR, 'bgm-night.wav'), night.left, night.right, SAMPLE_RATE);
