    ...
    <>
      <div className="mb-8 flex items-center justify-between gap-3">
        ...
        <div className="flex items-center gap-2">
          <span className="hidden max-w-[12rem] truncate text-xs text-white/45 sm:inline">
            {adminEmail}
          </span>
          {signOutSlot}
          <Link
              ...
              <div className="space-y-3">
                <label className="block">
                  ...
                  <input
                    ...
                    placeholder="4자 이상"
                    className="w-full rounded-xl border border-white/15 bg-black/40 px-4 py-3 text-sm font-semibold text-white outline-none transition placeholder:text-white/30 focus:border-amber-400/50 focus:ring-2 focus:ring-amber-400/30"
                  />
                </label>
                <label className="block">
